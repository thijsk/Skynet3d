      ...
      lcd_implementation_update_indicators();
		...
		if (buttons_reprapworld_keypad != 0)
		{
			...
			if ((currentScreen == lcd_main_menu) || (currentScreen == lcd_tune_menu) || (currentScreen == lcd_prepare_menu) || (currentScreen == lcd_control_menu)
				...
				|| (currentScreen == lcd_control_temperature_menu) || (currentScreen == lcd_control_temperature_preheat_material1_settings_menu) || (currentScreen == lcd_control_temperature_preheat_material2_settings_menu)\
